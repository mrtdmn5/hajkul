  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div ref={floatingElementsRef} className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute top-3/4 right-1/4 w-24 h-24 glass rounded-full bg-purple-500/10 opacity-50 backdrop-blur-xl"></div>
        ...
        <div className="absolute top-1/3 right-1/5 w-20 h-20 bg-gradient-to-br from-purple-500/20 to-cyan-500/20 rounded-3xl blur-sm transform rotate-45"></div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          <motion.div
            ...
            className="inline-block px-4 py-1.5 mb-6 rounded-full glass border border-white/20 text-sm font-medium tracking-wide text-cyan-300"
          >
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold font-poppins leading-tight mb-8">
            {content.hero.title.split(' ').map((word, i) => (
              word === 'Innovative' || word === 'Solutions' ? 
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#contact"
              className="px-8 py-4 rounded-full bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 text-white font-semibold flex items-center gap-2 hover:shadow-[0_0_20px_rgba(99,102,241,0.5)] transition-all duration-300 relative overflow-hidden group"
            >
