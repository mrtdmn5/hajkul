...
import { Send, MapPin, Mail, CheckCircle, AlertCircle, Loader2, Linkedin } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <div className="space-y-8 mt-12">
              ...
              <div className="flex items-start gap-4">
                <div className="p-4 rounded-xl bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 glass group transition-all duration-300 hover:border-[var(--color-main-secondary)] hover:shadow-[0_0_15px_var(--color-main-secondary)]">
                  <Linkedin className="w-6 h-6 group-hover:text-[var(--color-main-secondary)] transition-colors" />
                </div>
                <div>
                  <h5 className="text-sm font-semibold uppercase tracking-widest text-slate-500 mb-1">Connect</h5>
                  <p className="text-white text-lg font-medium">LinkedIn</p>
                  <a href={content.contact.linkedin} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-[var(--color-main-secondary)] transition-colors">
                    TypeofX Consulting AB
                  </a>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <motion.button
                ...
                className={`w-full py-4 rounded-xl font-semibold flex items-center justify-center gap-3 transition-all group ${status === 'submitting'
